...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleValidation(MethodArgumentNotValidException ex) {
        ...
        // Field lỗi chi tiết được đính kèm qua "properties" mở rộng của RFC 7807,
        // thay vì có một field "errors" cố định như ApiResponse cũ.
    ...
    public ResponseEntity<ProblemDetail> handleFileStorage(FileStorageException ex) {
    ...
    public ResponseEntity<ProblemDetail> handleFileValidation(FileValidationException ex) {
